...
export default function GlobalAIChat({ isOpen, onClose }: GlobalAIChatProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: '❌ 抱歉，AI 处理失败。请检查网络或设置。' }]);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <>
      ...
      <div style={{
        ...
        width: '600px', maxWidth: '90vw', height: '700px', maxHeight: '90vh',
        backgroundColor: 'var(--bg-panel)', borderRadius: '16px',
        ...
        <div style={{
          ...
          background: 'linear-gradient(to right, var(--bg-panel), var(--bg-panel-hover))'
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>全局知识库检索</h3>
        ...
        <div style={{
          ...
          {messages.length === 0 ? (
            <div style={{
              ...
              alignItems: 'center', justifyContent: 'center', color: 'var(--text-tertiary)', gap: '16px'
            }}>
              <Bot size={48} opacity={0.5} />
              <div style={{ textAlign: 'center' }}>
                <p style={{ margin: '0 0 8px 0', fontSize: '16px', fontWeight: 500, color: 'var(--text-secondary)' }}>
                  我是你的私人知识库管家
                </p>
            ...
            messages.map((msg, idx) => (
              <div key={idx} style={{
                ...
                <div style={{
                  ...
                  backgroundColor: msg.role === 'user' ? '#3b82f6' : 'var(--bg-input)',
          ...
          {isLoading && (
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <div style={{ padding: '12px', color: 'var(--text-tertiary)', fontSize: '14px' }}>
                正在检索知识库并思考...
              </div>
            </div>
          )}
        ...
        {/* Input Form */}
        <div style={{ padding: '20px', borderTop: '1px solid var(--border-color)', backgroundColor: 'var(--bg-panel)' }}>
          <form onSubmit={handleSubmit} style={{ position: 'relative' }}>
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: query.trim() && !isLoading ? '#10b981' : 'var(--border-color)',
